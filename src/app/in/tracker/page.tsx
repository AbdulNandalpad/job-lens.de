      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '24px 20px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 24 }}>
          ...
          <button onClick={() => setShowAdd(p => !p)}
            style={{ padding: '9px 20px', borderRadius: 8, background: `linear-gradient(135deg, ${accent}, #e67300)`, color: '#fff', border: 'none', cursor: 'pointer', fontFamily: f.heading, fontSize: 13, fontWeight: 700 }}>
            + Add manually
          </button>
        </div>
