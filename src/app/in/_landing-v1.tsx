// STANDBY — the pre-2026-08 dark India landing (full old page incl. auth branch),
// replaced by src/components/IndiaLanding.tsx rendered from in/page.tsx.
// Not a route (not named page.tsx). To restore: copy back over src/app/in/page.tsx.
      ...
      <footer style={{ background: navy, padding: '36px 24px 28px' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/guides" style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)', textDecoration: 'none' }}>Germany Visa Guides</Link>
            ...
            <Link href="/contact" style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)', textDecoration: 'none' }}>Contact</Link>
          </div>
        </div>
      </footer>
