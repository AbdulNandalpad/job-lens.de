      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <Section title="1. Verantwortlicher">
          ...
          <p style={{ margin: 0 }}>
            ...
            [PLZ] [Stadt]<br />
            Deutschland<br />
            E-Mail: <a href="mailto:kontakt@job-lens.de" style={{ color: c.accent }}>kontakt@job-lens.de</a>
          </p>
        </Section>
        ...
        <Section title="6. Ihre Rechte nach DSGVO">
          ...
          <p style={{ margin: '16px 0 0' }}>
            ...
            <a href="mailto:kontakt@job-lens.de" style={{ color: c.accent }}>kontakt@job-lens.de</a>.
