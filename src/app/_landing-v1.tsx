// STANDBY — the pre-2026-08 DACH landing (feature-grid hero), replaced by the
// Kira-first landing now in src/app/page.tsx. Not a route (not named page.tsx).
// To restore: copy this file's content back over src/app/page.tsx.
'use client'
