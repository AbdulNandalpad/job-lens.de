    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {mode === 'insights' && (
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div style={{ background: 'linear-gradient(135deg, #f0fbf6, #e8f8f2)', border: '1px solid #b6ecd8', borderRadius: 14, padding: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                <div style={{ width: 28, height: 28, borderRadius: 8, background: '#1D9E75', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14 }}>&#10003;</div>
          ...
          <div style={{ background: '#fff', border: '1px solid #edf1f6', borderRadius: 14, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              <div style={{ width: 28, height: 28, borderRadius: 8, background: '#E6F1FB', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14 }}>&#127919;</div>
          ...
          <div style={{ background: '#fff', border: '1px solid #edf1f6', borderRadius: 14, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              <div style={{ width: 28, height: 28, borderRadius: 8, background: '#FFF8EC', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14 }}>&#9889;</div>
      ...
      {mode === 'roast' && (
        <div style={{ background: 'linear-gradient(135deg, #1a0505, #2d0a0a)', border: '1.5px solid #E24B4A', borderRadius: 16, padding: 20, position: 'relative', overflow: 'hidden' }}>
          ...
          {[
            result.gaps[0] && `Your CV says "${result.readiness}" but recruiters see zero quantified results. That is not a profile &mdash; that is a blank canvas.`,
