              ...
              {features.map((feat, i) => (
                ...
                >
                  ...
                  <div style={{ transform:'skewX(6deg)', display:'flex', flexDirection:'column' as const, alignItems:'center', gap:14, textAlign:'center' as const }}>
                    ...
                    <div>
                      <div style={{ fontFamily:f.heading, fontSize:12, fontWeight:700, color:'#fff', marginBottom:6, lineHeight:1.3 }}>{feat.name}</div>
                      <div style={{ fontSize:10, color:'rgba(255,255,255,0.35)', lineHeight:1.55, maxWidth:80 }}>{feat.desc}</div>
                    </div>
                  </div>
                </Link>
              ))}
