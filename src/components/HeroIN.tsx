...
const SLIDES: Slide[] = [
  {
    ...
    h1:       'Land your next role',
    h1Accent: 'in the Indian market.',
    sub:      'ATS Score, CV builder, cover letter, Auto Apply and Kira AI — all in one place. Built for Naukri, LinkedIn and every company portal in India.',
  ...
  },
  {
    ...
    sub:      'Paste your CV and any job description. Kira scores your resume against ATS criteria, lists missing keywords, and flags format issues — keyword by keyword.',
    cta:      'Check ATS Score',
    href:     '/in/career-scan',
  },
  {
  ...
  },
  {
    ...
    sub:      'Paste any Naukri, LinkedIn or company portal URL. Kira reads the form, fills CTC, notice period, skills — everything. You review, then confirm.',
    cta:      'Try Auto Apply',
    href:     '/in/auto-apply',
  },
]
